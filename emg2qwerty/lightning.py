...
class CNNLSTMCTCModule(pl.LightningModule):
    """CNN + LSTM hybrid model for CTC-based sequence modeling"""
...
class CNNPyramidalLSTMCTCModule(pl.LightningModule):
    """CNN + Pyramidal BiLSTM model for CTC-based sequence modeling"""
    ...
    def __init__(
        ...
        self.reduction_factor = 2 ** (lstm_layers - 1)
    ...
    def _compute_emission_lengths(
        ...
        emission_lengths = base_lengths // self.reduction_factor
        return emission_lengths
    ...
    def _step(
        ...
        **kwargs,
        ...
        emission_lengths = self._compute_emission_lengths(
            input_lengths, inputs, emissions
        )
